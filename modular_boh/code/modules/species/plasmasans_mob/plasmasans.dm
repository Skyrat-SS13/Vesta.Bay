...
/datum/species/plasmasans
	...
	icobase = 'modular_boh/icon/mob/species/plasmasans/body.dmi'
	deform = 'modular_boh/icon/mob/species/plasmasans/deformed_body.dmi'
	husk_icon = 'modular_boh/icon/mob/species/plasmasans/husk.dmi'
	preview_icon = 'modular_boh/icon/mob/species/plasmasans/preview.dmi'
...
/mob/living/carbon/human/plasmasans/vomit(timevomit = 0, level = 0, delay = 0, deliberate = FALSE)
	return
