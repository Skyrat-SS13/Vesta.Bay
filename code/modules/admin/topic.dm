...
//Regular jobs
	...
	// call dibs on IC messages (prays, emergency comms, faxes)
		...
		H.equip_to_slot_or_store_or_drop( new /obj/item/weapon/reagent_containers/food/snacks/cookie(H), slot_l_hand )
		if(!(istype(H.l_hand,/obj/item/weapon/reagent_containers/food/snacks/cookie)))
			H.equip_to_slot_or_store_or_drop( new /obj/item/weapon/reagent_containers/food/snacks/cookie(H), slot_r_hand )
