...
/proc/AnnounceArrival(var/mob/living/carbon/human/character, var/datum/job/job, var/join_message)
	...
	//AnnounceArrivalSimple(character.real_name, rank, join_message, get_announcement_frequency(job)) // for higher pop
	AnnounceArrivalSimple(character.real_name, rank, join_message, "Common") // for lower pop - Codingale
