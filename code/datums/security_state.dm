...
/decl/security_level/default/code_delta
	...
	var/static/datum/announcement/priority/security/security_announcement_delta = new(do_log = 0, do_newscast = 1, new_sound = sound('modular_boh/sounds/self_destruct.ogg'))
