...
/datum/antagonist/revolutionary
	...
	victory_text = "The Andromeda has fallen to the mutiny, and its future is now in question."
...
/datum/antagonist/loyalists
	...
	victory_text = "The Andromeda is free of the mutineers, although the cost has yet to be discovered in full."
	loss_text = "The mutineers have won; the Andromeda will never be the same."
