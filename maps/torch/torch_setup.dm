...
/datum/map/torch/get_map_info()
	. = list()
	. += "Congratulations on your secondment on the SFV (Sol Forces Vessel) Andromeda."
	...
	. += ""
	. += "It is a re-commissioned science vessel revamped to be a fully functioning Sol Forces Vessel."
	. += "Capable of responding both to deal with most insurrectionist threats in a rapid fashion as well as explore any 'forgotten' planets in these sectors."
	return jointext(., "<br>")

/datum/map/torch/send_welcome()
	var/obj/effect/overmap/visitable/ship/torch = SSshuttle.ship_by_type(/obj/effect/overmap/visitable/ship/torch)

	var/welcome_text = "<center><img src = nteflogo.png /><br /><font size = 3><b>SFV Andromeda</b> Sensor Readings:</font><br>"
	...
	post_comm_message("SFV Andromeda Sensor Readings", welcome_text)
