/decl/hierarchy/outfit/job/torch
	name = OUTFIT_JOB_NAME("Andromeda Outfit")
...
/decl/hierarchy/outfit/job/torch/crew
	name = OUTFIT_JOB_NAME("Andromeda Crew Outfit")
...
/decl/hierarchy/outfit/job/torch/crew/fleet
	name = OUTFIT_JOB_NAME("Andromeda Fleet Outfit")
...
/decl/hierarchy/outfit/job/torch/passenger
	name = OUTFIT_JOB_NAME("Andromeda Passenger")
