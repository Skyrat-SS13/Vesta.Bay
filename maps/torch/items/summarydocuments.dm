...
/obj/item/documents/generic/dept/notoffical
	name = "offical guides"
	desc = "Some \"internal use only\" reports on inter-departmental communications, reminding personnel that unless the document specifies it is from and issued by SCGF or SCG Fleet Command, it is not offical policy and should not be referenced as a definitive reasoning for any action."
...
/obj/item/document/generic/scgr/boringreports
	name = "\improper Andromeda project status update #132"
...
/obj/item/documents/generic/sol/unathiwork
	...
	desc = "An \"internal use only\" memo from a mid-level officer at Fleet Command containing common sinta'unathi behaviors that help explain some of their quirky behaviors. A bullet list contains various hints such as \"thumping the tail is a sign of itchiness\", \"unathi hiss when they are angry\", and \"letting you touch their tail is a sign of great trust\". The document seems very hastily-made and you're not sure you trust it fully."
...
/obj/item/documents/generic/sup/skrellcookery
	...
	desc = "An \"internal use only\" memo sent from the Executive Officer on behalf of Fleet Command detailing how to provision meals for Skrell crew. The memo seems to be vaguely misinformed and claims that Skrell should only be given hallucinogenic mushrooms and toast."

/obj/item/documents/generic/sup/gasprovisioning
	name = "food for alien species memo"
	desc = "An \"internal use only\" memo sent from the Executive Officer on behalf of Fleet Command detailing how to provision meals for Giant Armored Serpentid staff. It implies quite heavily that cost is a concern, and they should not be given meat except in exceptional circumstances and should otherwise only be given cheap cabbage."

/obj/item/documents/generic/sup/shotgunblues
	name = "in defense of the bar"
	desc = "An \"internal use only\" memo sent from the Executive Officer on behalf of Fleet Command detailing that the service department does not need self-defense weapons, and any arguments to the contrary will be handled internally. A personal memo has been added; an underlined \"STOP ASKING US\" penned onto the page."
...
/obj/item/documents/generic/eng/repairs
	...
	desc = "Some \"confidential\" reports regarding the state of the SFV Andromeda. Of note are the rusty cistern, faulty disposal pipes, clogged sinks, and an under-sized atmospheric system."
...
/obj/item/documents/generic/corp/stipendcut
	...
	desc = "A \"confidential\" memo on the current usage of funds provided to SFV Andromeda corporate liaisons; apparently there's threats of a strike over a cut to the cost-of-living stipends by the head office."

/obj/item/documents/generic/corp/LPArenting
	name = "\improper LPA usage notice"
	desc = "A \"confidential\" notice to the corporate liaison aboard the SFV Andromeda that their security staff are for their use only, and renting them out as extra manpower to security is a gross violation of their contract."
...
/obj/item/documents/generic/corp/exointerest
	...
	desc = "Some \"confidential\" corporate documents directed to the corporate liasion, informing them that their job is to represent EXO and its immediate interests, which are to ensure the SFV Andromeda is able to maintain the currently defined direction that is within the interests of EXO as a whole. "
...
/obj/item/documents/generic/corp/spellchecker
	...
	desc = "Some \"internal use only\" corporate memos reminding corporate liaisons to proofread reports. It details various reasons behind why correct spelling and punctuation help in making EXO and Fleet Command take your report seriously."
