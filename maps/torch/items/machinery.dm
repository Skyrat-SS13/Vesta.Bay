...
/obj/machinery/drone_fabricator/torch
	fabricator_tag = "NTSS Andromeda Maintenance"
...
/obj/machinery/telecomms/hub/preset
	...
	"supply", "service", "common", "command", "engineering", "security", "exploration", "receiverA", "broadcasterA", "infantry")

/obj/machinery/telecomms/receiver/preset_right
	freq_listening = list(AI_FREQ, SCI_FREQ, MED_FREQ, SUP_FREQ, SRV_FREQ, COMM_FREQ, ENG_FREQ, SEC_FREQ, ENT_FREQ, EXP_FREQ, MED_I_FREQ, SEC_I_FREQ, INF_FREQ)
