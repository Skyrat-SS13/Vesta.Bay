...
/obj/item/weapon/card/id/torch
	...
	desc = "An identification card issued to personnel aboard the SFV Andromeda."
...
/obj/item/weapon/card/id/torch/crew
	desc = "An identification card issued to SolGov crewmembers aboard the SFV Andromeda."
	color = "#d3e3e1"
...
/obj/item/weapon/card/id/torch/contractor
	desc = "An identification card issued to private contractors aboard the SFV Andromeda."
	job_access_type = DEFAULT_JOB_TYPE
	color = COLOR_GRAY80
...
/obj/item/weapon/card/id/torch/crew/research
	desc = "A card issued to science personnel aboard the SFV Andromeda."
...
/obj/item/weapon/card/id/torch/passenger
	desc = "A card issued to passengers aboard the SFV Andromeda."
	job_access_type = DEFAULT_JOB_TYPE
	detail_color = COLOR_PAKISTAN_GREEN

/obj/item/weapon/card/id/torch/passenger/research
	desc = "A card issued to corporate personnel aboard the SFV Andromeda."
	job_access_type = /datum/job/scientist_assistant
