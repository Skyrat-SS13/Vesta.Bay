...
/obj/item/weapon/gun/projectile/revolver/medium/captain
	...
	icon = 'maps/torch/icons/obj/uniques.dmi'
	icon_state = "mosley"
	desc = "A shiny al-Maliki & Mosley Autococker automatic revolver, with black accents. Marketed as the 'Revolver for the Modern Era'. This one has 'To the Captain of NTSS Andromeda' engraved."
